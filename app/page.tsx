    ...
    >
      ...
      >
        ...
        <div className="hidden md:flex items-center gap-12 mono text-xs text-fg-secondary">
          <Link href="#features" className="hover:text-foreground transition-colors uppercase tracking-widest">Core Tech</Link>
          <Link href="#architecture" className="hover:text-foreground transition-colors uppercase tracking-widest">Architecture</Link>
          <Link href="#data" className="hover:text-foreground transition-colors uppercase tracking-widest">Data Model</Link>
          <Link href="#docs" className="hover:text-foreground transition-colors uppercase tracking-widest">Docs</Link>
        </div>
